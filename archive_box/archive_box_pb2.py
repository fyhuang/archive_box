...
_STOREDDATAID = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='archive_box.StoredDataId.id', index=1,
