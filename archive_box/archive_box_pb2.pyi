...
class StoredDataId(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"blob",b"blob",u"schema",b"schema"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"blob",b"blob",u"schema",b"schema"]) -> None: ...
...
class Document(google___protobuf___message___Message):
    ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"data_id",b"data_id",u"display_name",b"display_name",u"id",b"id"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"data_id",b"data_id",u"display_name",b"display_name",u"id",b"id",u"metadata",b"metadata",u"tags",b"tags"]) -> None: ...
